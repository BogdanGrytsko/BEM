...
{
    internal class PaperSpherePowExp
    {
        ...
        public void DoWork()
        {
            ...
            sw.Start();
            var bound = new Sphere(new Point3D(0, 0, 0));
            var boundWithCondition = ConditionSetter.SetBoundSphereKirghoffCondition(bound).ToList();
